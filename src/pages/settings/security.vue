...
<template>
  <div class="flex flex-col">
    ...
    <div class="flex flex-col gap-2 mb-5">
      ...
      <p-btn secondary>Change your PIN</p-btn>
    </div>

    <div class="flex flex-col mb-5">
      <p-checkbox v-model="isProtectMode" label="Enable enhanced security" toggle />
      <p class="ml-11 text-gray-500">Enhanced security will require your PIN or password for transactions and accessing sensitive profile data.</p>
    </div>

    <div class="flex flex-col gap-1">
      <p>App lock timeout</p>
      <p class="text-gray-500">Automatically lock the app after a period of inactivity.</p>
